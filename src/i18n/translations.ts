...
export const veh = {
  fr: {
    ...
    deposit: 'Caution : 900 € — pré-autorisée', depositNote: 'Assurez-vous d\'avoir au moins 900 € disponibles sur votre carte avant de réserver : la caution est vérifiée et bloquée avant le paiement de la location (aucune somme débitée).',
    depositFaq: "Qu'est-ce qu'une pré-autorisation ?",
    cautionEchecTitle: 'La caution de 900 € n\'a pas pu être autorisée',
    cautionEchecMsg: 'Vérifiez que ce montant est bien disponible sur votre carte bancaire, puis relancez votre réservation. Le paiement de la location n\'a pas été effectué.',
  ...
  en: {
    ...
    deposit: 'Deposit: €900 — pre-authorised', depositNote: 'Make sure you have at least €900 available on your card before booking: the deposit is verified and held before the rental payment (nothing is charged).',
    depositFaq: 'What is a pre-authorisation?',
    cautionEchecTitle: 'The €900 deposit could not be authorised',
    cautionEchecMsg: 'Please check that this amount is available on your card, then start your booking again. The rental payment was not charged.',
  ...
  es: {
    ...
    deposit: 'Depósito: 900 € — preautorizado', depositNote: 'Asegúrate de tener al menos 900 € disponibles en tu tarjeta antes de reservar: el depósito se verifica y se bloquea antes del pago del alquiler (no se carga ninguna suma).',
    depositFaq: '¿Qué es una preautorización?',
    cautionEchecTitle: 'No se pudo autorizar el depósito de 900 €',
    cautionEchecMsg: 'Comprueba que este importe esté disponible en tu tarjeta y vuelve a iniciar tu reserva. No se ha cobrado el pago del alquiler.',
  ...
  it: {
    ...
    deposit: 'Deposito: 900 € — pre-autorizzato', depositNote: 'Assicurati di avere almeno 900 € disponibili sulla tua carta prima di prenotare: la cauzione viene verificata e bloccata prima del pagamento del noleggio (nessun importo addebitato).',
    depositFaq: "Cos'è una pre-autorizzazione?",
    cautionEchecTitle: 'Non è stato possibile autorizzare la cauzione di 900 €',
    cautionEchecMsg: 'Verifica che questo importo sia disponibile sulla tua carta, quindi riavvia la prenotazione. Il pagamento del noleggio non è stato effettuato.',
