// src/pages/api/admin/vehicule-prix.ts — Sauvegarde les 4 prix de saison d'un véhicule
...
export const PUT: APIRoute = async ({ request }) => {
  ...
  const { vehicule_id, prix_basse, prix_moyenne, prix_haute, prix_tres_haute } = body;
  ...
  if (prix_tres_haute !== undefined) update.prix_tres_haute = prix_tres_haute ? Number(prix_tres_haute) : null;
